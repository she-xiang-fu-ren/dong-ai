...
public class XunFeiTest extends WebSocketListener {
    ...
    // 构造函数
    public XunFeiTest(String userId, Boolean wsCloseFlag) {
        this.userId = userId;
    ...
    public static void main(String[] args) throws Exception {
      ...
      while (true){
          if(totalFlag){
              ...
              for (int i = 0; i < 1; i++) {
                  totalAnswer="";
                  WebSocket webSocket = client.newWebSocket(request, new XunFeiTest(i + "",
                          false));
              }
          }else{
              Thread.sleep(200);
